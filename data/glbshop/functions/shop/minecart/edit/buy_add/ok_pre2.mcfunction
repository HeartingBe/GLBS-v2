...
#不合法
execute if score #GLBStemp_price GLBSinfo matches 0 run tellraw @p[distance=..5,tag=GLBSop] [">> \u00a7c需要指定回收物品的价格"]

#合法
execute unless score #GLBStemp_price GLBSinfo matches 0 run function mny:glbs/minecart/edit/buy_add/ok